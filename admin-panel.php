...
<html>
        ...
        <div class="col-md-3">
            ...
            <div class="list-group">
                <a href="" class="list-group-item active"
                   >Members</a>
                <a href="homepage.php" class="list-group-item">Homepage</a>   
 ...
 <nav>
     <div class="main-wrapper">
            ...
            <hr>
            <div class="list-group">
              <a href="trainer.php" class="list-group-item active">Group Mentor</a>
              <a href="trainer.php" class="list-group-item active">Mentor details</a>             
              <a href="trainer.php" class="list-group-item active">Add new Mentor</a>
            </div>      
